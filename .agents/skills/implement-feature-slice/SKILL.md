...
7. Mark the roadmap item `Done` only after every acceptance criterion passes. Record commands, outcomes, remaining risks, and the next bottleneck in `docs/LOOP_LOG.md`.
